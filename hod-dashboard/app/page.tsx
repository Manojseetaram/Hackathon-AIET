...
//           <RegisterForm onSuccess={handleAuthSuccess} onLogin={() => setCurrentView("login")} />
//         )}

//         {currentView === "forgot-password" && (
//           <ForgotPasswordForm onSuccess={handleForgotPasswordSuccess} onBack={() => setCurrentView("login")} />
//         )}
//       </div>
//     </div>
//   )
